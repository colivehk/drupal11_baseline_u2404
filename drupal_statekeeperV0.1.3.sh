...
Usage:
  Snapshot:
    sudo -E bash drupal_statekeeperV0.1.3.sh snapshot [--incremental] [--force] [--with-files] [--with-db]
      [--uri=http://IP] [--drupal-dir=/var/www/drupal]

  Apply:
    sudo -E bash drupal_statekeeperV0.1.3.sh apply --from=/path/to/drupal_snapshot_YYYYmmdd_HHMMSS.tar.gz
