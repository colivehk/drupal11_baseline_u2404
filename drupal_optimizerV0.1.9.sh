...
#
# Usage:
#   sudo -E bash drupal_optimizerV0.1.9.sh
#   sudo -E PROD_STRICT=1 bash drupal_optimizerV0.1.9.sh     # production-like OPcache (no timestamp checks)
#   sudo -E ENABLE_DRUPAL_PERF_CONFIG=0 bash drupal_optimizerV0.1.9.sh  # skip drush config:set tuning
#
